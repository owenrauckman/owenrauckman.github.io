...
var Landing = function () {
  function Landing() {
    ...
    this.config = {
      ...
      slideshow: '#js__hero__slideshow',
      animationTopHeight: '48px',
      bookImage: '.landing__hero__content .landing__hero__content__book__img'
    };
  }
  ...
  _createClass(Landing, [{
    ...
    value: function getNextSlide() {
      ...
      (0, _jquery2.default)(this.config.heroContentFirstChild).hide().css({ opacity: 0 }).next().css({ display: 'flex' }).animate({
        opacity: 1
      }, 200, function () {
        // set the hidden books back to 48px and animate the new one up
        (0, _jquery2.default)(_this.config.firstChildImage).animate({ top: '0' }, 100);
        (0, _jquery2.default)(_this.config.bookImage).css({ top: '48px' }, 100);
      }).end().appendTo(this.config.slideshow);
    }
  }, {
    key: 'getPrevSlide',
    value: function getPrevSlide() {
      ...
      (0, _jquery2.default)(this.config.heroContentFirstChild).hide().css({ opacity: 0 });
      (0, _jquery2.default)(this.config.heroContentLastChild).prependTo(this.config.slideshow).hide();
      (0, _jquery2.default)(this.config.heroContentFirstChild).css({ display: 'flex' }).animate({ opacity: 1 }, 200, function () {
        // set the hidden books back to 48px and animate the new one up
        (0, _jquery2.default)(_this2.config.firstChildImage).animate({ top: '0' }, 100);
        (0, _jquery2.default)(_this2.config.bookImage).css({ top: '48px' }, 100);
      });
    }
  }, {
    key: 'initialPageAnimation',
